...
COMMENT ON COLUMN ACCOUNT_TB.ENROLL_DATE IS '계좌개설일';
COMMENT ON COLUMN ACCOUNT_TB.TRADE_DATE IS '최근거래일';
COMMENT ON COLUMN ACCOUNT_TB.BALANCE IS '계좌잔액';

-- ============================================
-- ACCOUNT_TB 샘플 데이터
-- ============================================
INSERT INTO ACCOUNT_TB (ACC_NUM, ACC_PWD, CUS_NO, ACC_STATUS, ENROLL_DATE, TRADE_DATE, BALANCE)
VALUES ('425123-01-424253', 1234, 4, 'Y', '2025/08/20', '2025/08/20', 1000000);
INSERT INTO ACCOUNT_TB (ACC_NUM, ACC_PWD, CUS_NO, ACC_STATUS, ENROLL_DATE, TRADE_DATE, BALANCE)
VALUES ('425123-01-613451', 1234, 4, 'Y', '2025/08/20', '2025/08/20', 1500000);
INSERT INTO ACCOUNT_TB (ACC_NUM, ACC_PWD, CUS_NO, ACC_STATUS, ENROLL_DATE, TRADE_DATE, BALANCE)
VALUES ('474233-01-424253', 1234, 2, 'Y', '2025/08/20', '2025/08/20', 70000000);
INSERT INTO ACCOUNT_TB (ACC_NUM, ACC_PWD, CUS_NO, ACC_STATUS, ENROLL_DATE, TRADE_DATE, BALANCE)
VALUES ('985622-01-424253', 1234, 3, 'Y', '2025/08/20', '2025/08/20', 500000);
--===============계좌거래내역테이블==================
CREATE TABLE TRADE_LOG(
    ACC_NUM CHAR(16) REFERENCES ACCOUNT_TB(ACC_NUM),
    TRADE_AMOUNT NUMBER,
    TRADE_TIME DATE DEFAULT SYSDATE,
    TRADE_CATEGORY VARCHAR2(20),
    TRADE_CONTENT VARCHAR2(100),
    TRADE_LOCATION VARCHAR2(100)
);
--==================TRADE_LOG코멘트============
COMMENT ON COLUMN TRADE_LOG.TRADE_AMOUNT IS '거래액';
COMMENT ON COLUMN TRADE_LOG.TRADE_TIME IS '거래시간';
COMMENT ON COLUMN TRADE_LOG.TRADE_CATEGORY IS '거래종류';
COMMENT ON COLUMN TRADE_LOG.TRADE_CONTENT IS '거래내용';
COMMENT ON COLUMN TRADE_LOG.TRADE_LOCATION IS '거래장소';
--================TRADE_LOG 샘플데이터===========
INSERT INTO TRADE_LOG(TRADE_AMOUNT, TRADE_TIME, TRADE_CATEGORY, TRADE_CONTENT, TRADE_LOCATION)
VALUES(3500000, '2025/08/20', '입금', '급여이체', 'KH금융');
INSERT INTO TRADE_LOG(TRADE_AMOUNT, TRADE_TIME, TRADE_CATEGORY, TRADE_CONTENT, TRADE_LOCATION)
VALUES(-200000, '2025/08/21', '출금', 'ATM출금', '강남역점');
INSERT INTO TRADE_LOG(TRADE_AMOUNT, TRADE_TIME, TRADE_CATEGORY, TRADE_CONTENT, TRADE_LOCATION)
VALUES(-890000, '2025/08/23', '계좌이체', '온라인쇼핑', '쿠팡');
INSERT INTO TRADE_LOG(TRADE_AMOUNT, TRADE_TIME, TRADE_CATEGORY, TRADE_CONTENT, TRADE_LOCATION)
VALUES(450000, '2025/08/24', '입금', '세금환급금', '국세청');
INSERT INTO TRADE_LOG(TRADE_AMOUNT, TRADE_TIME, TRADE_CATEGORY, TRADE_CONTENT, TRADE_LOCATION)
VALUES(150000, '2025/08/26', '자동이체', '적금납입', 'KH정기적금');
--=================================================
----------------- 첨부파일 테이블 -------------------
...
-- 휴가 상태 트리거
-- ============================================
CREATE OR REPLACE TRIGGER TRG_VAC -- 휴가 상태 Y/N 자동 갱신 트리거
...
CREATE TABLE PROJECT_TB ( -- 프로젝트 테이블
    ...
    PJT_ENROLLDATE DATE DEFAULT SYSDATE, -- 프로젝트 작성일
    PJT_COUNT NUMBER DEFAULT 0, -- 조회수
    PJT_STATUS CHAR(20) DEFAULT 'upon' NOT NULL CHECK (PJT_STATUS IN ('afoot','upon','clear')), -- 프로젝트 상태(진행중(afoot) | 검토중(upon) | 완료(clear))
...
-- PROJECT_TB 샘플 데이터
-- ============================================
INSERT INTO PROJECT_TB (PJT_NO, EMP_NO, PJT_NAME, PJT_ENROLLDATE, PJT_CONTENT)
VALUES (SEQ_PNO.NEXTVAL, 100, 'ERP 구축', '2025-08-01', 'ERP 시스템 구축 프로젝트');
INSERT INTO PROJECT_TB (PJT_NO, EMP_NO, PJT_NAME, PJT_ENROLLDATE, PJT_CONTENT)
VALUES (SEQ_PNO.NEXTVAL, 101, 'CRM 도입', '2025-08-02', 'CRM 시스템 도입 프로젝트');
INSERT INTO PROJECT_TB (PJT_NO, EMP_NO, PJT_NAME, PJT_ENROLLDATE, PJT_CONTENT)
VALUES (SEQ_PNO.NEXTVAL, 102, '웹사이트 개선', '2025-08-03', '기업 웹사이트 개선 프로젝트');
INSERT INTO PROJECT_TB (PJT_NO, EMP_NO, PJT_NAME, PJT_ENROLLDATE, PJT_CONTENT)
VALUES (SEQ_PNO.NEXTVAL, 103, '모바일 앱 개발', '2025-08-04', '모바일 앱 개발 프로젝트');
INSERT INTO PROJECT_TB (PJT_NO, EMP_NO, PJT_NAME, PJT_ENROLLDATE, PJT_CONTENT)
VALUES (SEQ_PNO.NEXTVAL, 104, '인프라 확충', '2025-08-05', '서버 및 네트워크 인프라 확충 프로젝트');
...
CREATE TABLE MESSAGE_TB ( -- 메시지 테이블
    ...
    MSG_TITLE VARCHAR2(1000) DEFAULT '제목없음' NOT NULL, -- 메시지 제목
...
COMMENT ON COLUMN MESSAGE_TB.MSG_TITLE IS '메시지제목';
...
-- ============================================
INSERT INTO MESSAGE_TB (MSG_NO, EMP_SNO, EMP_RNO, MSG_TITLE, MSG_CONTENT)
VALUES (SEQ_MNO.NEXTVAL,100,101,'공지 A','공지사항 내용 A');

INSERT INTO MESSAGE_TB (MSG_NO, EMP_SNO, EMP_RNO, MSG_TITLE, MSG_CONTENT)
VALUES (SEQ_MNO.NEXTVAL,101,102,'공지 B','공지사항 내용 B');

INSERT INTO MESSAGE_TB (MSG_NO, EMP_SNO, EMP_RNO, MSG_TITLE, MSG_CONTENT)
VALUES (SEQ_MNO.NEXTVAL,102,103,'공지 C','공지사항 내용 C');

INSERT INTO MESSAGE_TB (MSG_NO, EMP_SNO, EMP_RNO, MSG_TITLE, MSG_CONTENT)
VALUES (SEQ_MNO.NEXTVAL,103,104,'공지 D','공지사항 내용 D');

INSERT INTO MESSAGE_TB (MSG_NO, EMP_SNO, EMP_RNO, MSG_TITLE, MSG_CONTENT)
VALUES (SEQ_MNO.NEXTVAL,104,101,'공지 E','공지사항 내용 E');
...
CREATE TABLE REQUIREMENT_TB (
    ...
    CONSTRAINT PK_REQUIREMENT PRIMARY KEY (REQ_NO),
    CONSTRAINT FK_REQUIREMENT_ATTACHMENT FOREIGN KEY (ATT_NO)
        REFERENCES ATTACHMENT_TB (ATT_NO),
    CONSTRAINT FK_REQUIREMENT_EMP FOREIGN KEY (EMP_NO)
        REFERENCES EMPLOYEE_TB (EMP_NO)
);
